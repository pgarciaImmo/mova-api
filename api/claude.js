...
const queries = [
zone1 + ' appartement vente achat ' + kwRenovation,
zone1 + ' vente achat ' + kwAtypique,
zone2 + ' appartement vente achat ' + kwRenovation,
zone1 + ' immeuble bureau local commercial vente achat prix euros'
];
...
Le jeu. 18 juin 2026 à 21:58, PAULO GARCIA <garciapaulo.7873@gmail.com> a écrit :
module.exports = async function handler(req, res) {
res.setHeader('Access-Control-Allow-Origin', '*');
res.setHeader('Access-Control-Allow-Methods', 'POST, OPTIONS');
res.setHeader('Access-Control-Allow-Headers', 'Content-Type');
